...
class DataHandler:
    ...
    def __init__(self, batch_location, number_batches, mini_batch_size, one_hot=True):
        ...
        with open(batch_location + '/batches.meta', 'rb') as f:
    ...
    def init_test_data(self):
        ...
        """
        with open(self.batch_location + '/test_batch', 'rb') as f:
    ...
    def get_all_train_data(self):
        ...
        for i in range(self.number_batches):
            with open(self.batch_location + '/data_batch_' + str(i + 1), 'rb') as df:
                data = pickle.load(df)
